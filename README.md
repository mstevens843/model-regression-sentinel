...
> - `pnpm verify:corpus` - 34 frozen cases checked byte for byte, and `shasum -a 256 -c
...
| Corpus ordering proof | `verify:freeze` | OPEN. UNAVAILABLE in this environment, and stated as such rather than as pending. |
